...
namespace ns8
{
	internal class ClassProxyv6
	{
		[CompilerGenerated]
		private sealed class ClassProxyv6z
		{
		...
		public ClassProxyv6(string string_3, int int_7, int int_8)
		{
			api_key = string_3;
			proxy = "";
			ip = "";
		...
		public static bool smethod_0(string string_3) // Check ngay xem api con xai dc k
		{
			string string_4 = "accept: */*";
			string text = smethod_1("https://api.proxyv6.net/api/user-info?api_key=", string_4);
			if (text != "")
			{
				try
				{
